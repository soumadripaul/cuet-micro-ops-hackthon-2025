  ...
  return (
    <div className="bg-white rounded-lg shadow p-6">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="p-4 bg-green-50 rounded-lg">
          <div className="flex items-center justify-between">
            <span className="text-sm text-green-600 font-medium">Success Rate</span>
            <TrendingUp className="h-4 w-4 text-green-600" />
          </div>
          <p className="text-2xl font-bold text-green-700 mt-2">{successRate}%</p>
        ...
        <div className="p-4 bg-red-50 rounded-lg">
          ...
          <p className="text-2xl font-bold text-red-700 mt-2">{metrics.failureCount}</p>
          <p className="text-xs text-red-600 mt-1">Failed requests</p>
        </div>

        <div className="p-4 bg-blue-50 rounded-lg col-span-2">
          <div className="flex items-center justify-between">
            <span className="text-sm text-blue-600 font-medium">Avg Response Time</span>
          </div>
      ...
      <div className="mt-4 p-3 bg-gray-50 rounded text-xs text-gray-600">
        <p>
          💡 <strong>Tip:</strong> Metrics are tracked via OpenTelemetry spans. Check Jaeger UI for
